    ...
    def __init__(
        ...
        for i, mult in enumerate(channel_mults):
            ...
            for _ in range(num_res_blocks):
                downs.append(ResidualBlock(in_ch, out_ch, time_emb_dim))
        ...
        # Middle
        mid_ch = in_ch
        self.mid1 = ResidualBlock(mid_ch, mid_ch, time_emb_dim)
        self.mid2 = ResidualBlock(mid_ch, mid_ch, time_emb_dim)
        ...
        for i, mult in list(enumerate(channel_mults))[::-1]:
            ...
            for _ in range(num_res_blocks):
                ...
                ups.append(ResidualBlock(in_ch + skip_ch, out_ch, time_emb_dim))
                in_ch = out_ch
            if i != 0:
